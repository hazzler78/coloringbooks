export default function Home() {
  return (
    <>
      {/* Global header is defined in RootLayout */}

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center px-4 py-8 md:py-16" style={{ background: 'linear-gradient(135deg, #F2EAE3 0%, #C5B9AC 50%, #A4BCC2 100%)' }}>
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          {/* Main Headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight px-2">
            <span className="bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(135deg, #8C6A2A, #A4BCC2)' }}>Premium Coloring Books</span><br />
            <span className="text-pantone8021">for Stress Relief</span>
          </h1>
          
          {/* Clear Value Proposition */}
          <p className="text-xl md:text-2xl mb-8 text-[#6F5220] max-w-2xl mx-auto leading-relaxed px-4">
          ...
          <div className="mb-8 px-4 space-y-4">
            <a 
              ...
              className="text-white font-bold py-4 px-8 rounded-xl text-xl shadow-2xl transform hover:scale-105 transition-all duration-300 inline-block"
              style={{ backgroundImage: 'linear-gradient(135deg, #8C6A2A, #A4BCC2)' }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                href="/generate" 
                className="bg-pantone7542 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:brightness-90 transition-all duration-300 inline-block"
              >
                🤖 Try AI Generator
              </a>
              <a 
                href="/coloring-demo" 
                className="bg-pantone8021 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:brightness-90 transition-all duration-300 inline-block"
              >
                🖌️ Interactive Demo
              </a>
            </div>
          ...
          {/* Trust Indicators */}
          <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 text-sm text-pantone8021 mb-8">
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-2 text-pantone8021" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 px-4" style={{ background: 'linear-gradient(135deg, #F2EAE3 0%, #C5B9AC 50%, #A4BCC2 100%)' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-pantone8021">
            🎨 Try Our AI Coloring Experience!
          </h2>
          <p className="text-xl text-[#6F5220] mb-8 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-pantone7542/30 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <a 
                href="/generate" 
                className="bg-pantone7542 text-white px-6 py-3 rounded-lg font-semibold hover:brightness-90 transition-colors inline-block"
              >
                Generate Now
              </a>
            </div>
            ...
            {/* Interactive Demo */}
            <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-pantone8021/20 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <a 
                href="/coloring-demo" 
                className="bg-pantone8021 text-white px-6 py-3 rounded-lg font-semibold hover:brightness-90 transition-colors inline-block"
              >
                Try Demo
              </a>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg max-w-2xl mx-auto">
            <h3 className="text-lg font-semibold mb-3 text-pantone8021">Why Try Our Digital Experience?</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center">
                <span className="text-pantone8021 mr-2">✓</span>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-pantone8021">
      ...
      {/* Benefits Section */}
      <section className="bg-[#F2EAE3] py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-pantone8021">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="w-12 h-12 bg-pantone7542/30 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-pantone8021" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-pantone8021 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-[#6F5220] rounded-xl p-6">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-pantone7528 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                  S
                </div>
                <div>
      ...
      <section className="py-16 px-4 text-center bg-white">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-pantone8021">Ready to Start Your Creative Journey?</h2>
        <p className="text-xl text-[#6F5220] mb-8 max-w-2xl mx-auto">
      ...
      <section className="py-12 px-4 bg-[#F2EAE3]" id="privacy-policy">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-4 text-pantone8021">Privacy Policy</h2>
          ...
          <p className="text-lg text-gray-700">
            For privacy questions, contact us at <a href="mailto:Wonderwallart@gmx.net" className="text-pantone8021 underline">Wonderwallart@gmx.net</a>.
          </p>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-pantone8021 text-white py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-[#E8DFD6]">
            © 2024 Premium Coloring Books. All rights reserved.
          </p>
          <p className="text-sm text-[#E8DFD6] mt-2">
